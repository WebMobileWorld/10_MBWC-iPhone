...
class WeekdaysViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        {
            if weekday == ((indexPath as NSIndexPath).row + 1) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let index = Global.weekdays.index(of: ((indexPath as NSIndexPath).row + 1)){
          Global.weekdays.remove(at: index)
            ...
            Global.weekdays.append((indexPath as NSIndexPath).row + 1)
